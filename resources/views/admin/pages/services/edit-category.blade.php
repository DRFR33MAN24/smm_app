                    ...
                    <div class="col-sm-6 col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="category_type" name="category_type">
                                <option value="{{old('category_type',$category->category_type)}}" selected
                                        hidden>@lang('Change Type')</option>
                               
                                   
                                            <option value="gift cards"  @if($category->category_type == "gift cards" ) selected @endif>Gift Cards</option>
                                            <option value="telecom"  @if($category->category_type == "telecom" ) selected @endif>Telecom</option>
                                            <option value="telecom credit"  @if($category->category_type == "telecom credit" ) selected @endif>Telecom Credit Transfer</option>
                                            <option value="social"  @if($category->category_type == "social" ) selected @endif>Social</option>
                                            <option value="utility"  @if($category->category_type == "utility" ) selected @endif>Utility</option>
                                                 <option value="games"  @if($category->category_type == "games" ) selected @endif>Games</option>
                                                      <option value="chat programs"  @if($category->category_type == "chat programs" ) selected @endif>Chat Programs</option>
                                                      <option value="internet"  @if($category->category_type == "internet" ) selected @endif>Internet</option>
                                            <option value="balance"  @if($category->category_type == "balance" ) selected @endif>Balance</option>
