                ...
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    @forelse($users as $user)
                        <tr>
                            ...
                            <td data-label="@lang('Username')">@lang($user->f_name) @lang($user->l_name)</td>
                            ...
                            <td data-label="@lang('Balance')">{{getAmount($user->lbalance, config('basic.fraction_number'))}} LBP </td>
