                        ...
                        <tr>
                            ...
                            <td data-label="@lang('User')">
                                <a href="{{route('admin.user-edit',$order->user_id)}}" target="_blank">
                                    @lang(optional($order->user)->f_name) @lang(optional($order->user)->l_name)
                                </a>
                            </td>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        @if(isset($order->refill_status) && ($order->refill_status != 'completed' || $order->refill_status != 'partial' || $order->refill_status != 'canceled' || $order->refill_status != 'refunded'))
                                            <a href="javascript:void(0)" class="dropdown-item refill-status-change"
                                               ...
                                               data-route="{{ route('admin.order.refill-status.change',['id' => $order->id])}}">
                                                <i class="fa fa-check pr-2 text-success"
                                                   aria-hidden="true"></i> @lang('Change Refill Status')
                                            </a>
                                        @endif
