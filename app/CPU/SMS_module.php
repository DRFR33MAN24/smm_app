...
class SMS_module
{
    ...
    {
        $config = self::get_settings('test_sms');
        if (isset($config) && $config['status'] == 1) {
            $response = self::test_sms($receiver, $otp);
            return $response;
        }
    ...
    public static function test_sms($receiver, $otp)
    {
    ...
    'username'   => 'kayali',
    'password'=>"Bmp46vLUzNtBFBp",
    'route'=>'wp',
    'senderid'=>'giftme_store'
    
];

curl_setopt($ch, CURLOPT_URL,"https://www.bestsmsbulk.com/bestsmsbulkapi/common/sendSmsWpAPI.php");
