...
class NotifyController extends Controller
{
    ...
    public function notifyConfig()
    {
        ...
        return view('admin.pages.notify.controls', compact('control'));
    }
    ...
    public function notifyConfigUpdate(Request $request)
    {
        ...
        $configure->push_notification = (int)$reqData['push_notification'];
        $configure->save();
    ...
    public function show()
    {
        ...
        return view('admin.pages.notify.show',compact('notifyTemplate'));
    }
    ...
    public function edit(NotifyTemplate $notifyTemplate, $id)
    {
        ...
        return view('admin.pages.notify.edit',compact('notifyTemplate','languages','templates'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->has('image')) {
            $notification->image = $this->uploadImage($request['image'], config('location.notification.path'), config('location.notification.size'));
        } else {
        ...
        try {
            ...
            return back()->with('error', 'Notification send error!');
        }
