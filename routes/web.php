...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::post('/user/balance-lbp-update/{id}', 'Admin\UsersController@userBalanceLBPUpdate')->name('user-balance-lbp-update');
        ...
        Route::post('/basic-controls', 'ControlController@update')->name('basic-controls.update');
        ...
        Route::post('/notify-template/store', 'Admin\NotifyController@store')->name('notify-template.store');
...
//     });
   ...
   Route::get('/', 'Admin\LoginController@showLoginForm')->name('home');
